...
function RepositoryDetail(){
   ...
   useEffect(()=>{
    const repositoryContent = JSON.parse(localStorage.getItem('selectedRepos'));
    setRepos(repositoryContent)
   }, []);
            ...
            <section className="repos-wrap" style={{backgroundColor:'#fff', padding:'30px'}}>
                ...
                <div className="repo-statics">
                    ...
                    <ul>
                        ...
                        <li>{repos?.open_issues_count?.toLocaleString()} open_issue</li>
